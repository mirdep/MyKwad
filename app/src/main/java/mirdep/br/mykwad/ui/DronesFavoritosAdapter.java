...
public class DronesFavoritosAdapter extends RecyclerView.Adapter<DronesFavoritosAdapter.MeuDroneViewHolder> {

    private List<Drone> drones;
    private Fragment parent;

    public DronesFavoritosAdapter(Fragment parent){
        this.parent = parent;

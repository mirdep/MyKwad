...
public class Model_EscolherPeca extends ViewModel {
    ...
    public Model_EscolherPeca(String tipoPeca){
        Log.d(NOME_LOG, "Model criado!");
        ...
        PecaRepositorio.getPecaDatabaseReference(tipoPeca).addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        Log.d(NOME_LOG, "Carregando peças do tipo: "+tipoPeca+"...");
